...
export default function StepPersonal({ data, onChange }) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-xl font-semibold text-ink mb-2">Informasi Dasar</h3>
        <p className="text-sm text-muted">Lengkapi data diri Anda untuk ditampilkan di CV.</p>
      </div>
      ...
      <div className="card p-5 space-y-4">
        <div className="flex items-center gap-2 pb-2 border-b border-border">
          ...
          <h4 className="font-medium text-ink">Informasi Pribadi</h4>
        </div>
      ...
      <div className="card p-5 space-y-4">
        <div className="flex items-center gap-2 pb-2 border-b border-border">
          ...
          <h4 className="font-medium text-ink">Informasi Kontak</h4>
        </div>
        <div className="grid md:grid-cols-2 gap-4">
          <Input 
            label="Email" 
      ...
      <div className="card p-5 space-y-4">
        <div className="flex items-center gap-2 pb-2 border-b border-border">
          ...
          <div>
            <h4 className="font-medium text-ink">Media Sosial & Portfolio</h4>
