...
export default function StepPersonal({ data, onChange }) {
 ...
 <div>
 <h3 className="text-lg font-semibold text-ink mb-1">Informasi Dasar</h3>
 <p className="text-sm text-muted mb-4">Lengkapi data diri Anda untuk ditampilkan di CV.</p>
 </div>
