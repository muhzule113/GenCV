...
export default function StepSkills({ data, onChange }) {
 ...
 <div>
 <h3 className="text-lg font-semibold text-ink mb-1">Keahlian</h3>
 <p className="text-sm text-muted mb-4">Tambahkan keahlian teknis dan soft skills.</p>
 </div>

 <div className="space-y-2">
 <div className="flex items-center justify-between gap-2">
 <div className="flex items-center gap-2 relative" ref={openHelp === 'tech' ? helpRef : null}>
 <label className="block text-sm font-medium text-ink ">Keahlian Teknis</label>
 <button
 type="button"
 ...
 <label className="block text-sm font-medium text-ink ">Interpersonal</label>
 <button
 type="button"
 ...
 <div>
 <h3 className="text-lg font-semibold text-ink mb-1">Bahasa</h3>
 <p className="text-sm text-muted mb-4">Tambahkan bahasa yang dikuasai (opsional).</p>
 </div>
 ...
 <div>
 <h3 className="text-lg font-semibold text-ink mb-1">Proyek & Portofolio</h3>
 <p className="text-sm text-muted mb-4">Tambahkan proyek yang pernah Anda kerjakan.</p>
 </div>
 ...
 <div>
 <h3 className="text-lg font-semibold text-ink mb-1">Sertifikasi</h3>
 <p className="text-sm text-muted mb-4">Tambahkan sertifikasi yang dimiliki (opsional).</p>
 </div>
