...
const styles = StyleSheet.create({
  ...
  academicItem: { fontSize: 9.5, color: '#111', marginBottom: 3, lineHeight: 1.4 },
})

export function AcademicMinimalTemplate({ data }) {
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        {data.experiences?.length > 0 && (
          <View>
            <Text style={styles.sectionTitle}>Pengalaman Akademik & Kerja</Text>
        ...
        {/* Publikasi - Akademik khusus */}
        {data.publications?.length > 0 && (
          <View>
            <Text style={styles.sectionTitle}>Publikasi</Text>
            {data.publications.map((pub, i) => (
              <Text key={i} style={styles.academicItem}>
        ...
        {/* Presentasi - Akademik khusus */}
        {data.presentations?.length > 0 && (
          <View>
            <Text style={styles.sectionTitle}>Presentasi & Konferensi</Text>
        ...
        {data.projects?.length > 0 && (
          <View>
            <Text style={styles.sectionTitle}>Proyek Riset & Lainnya</Text>
