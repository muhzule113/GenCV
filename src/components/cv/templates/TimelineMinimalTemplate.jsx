...
const styles = StyleSheet.create({
  ...
  timelineLeft: { width: 14, alignItems: 'center', marginRight: 4, position: 'relative' },
  timelineLine: { position: 'absolute', top: 5, bottom: -11, left: 6, width: 1, backgroundColor: '#D1D5DB' },
  timelineDot: { position: 'absolute', top: 5, left: 4, width: 5, height: 5, borderRadius: 2.5, backgroundColor: '#111827' },
  timelineRight: { flex: 1 },

  expHeader: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 1, alignItems: 'baseline' },
  expPosition: { fontWeight: 'bold', fontSize: 9.5, color: '#111827' },
  expDate: { fontSize: 7.5, color: '#6B7280' },
