...
export default function Sidebar() {
 ...
 `}
                ...
                <div className="pt-3 border-t border-border space-y-0.5">
                    <button onClick={() => setShowLogoutModal(true)} className="flex items-center gap-3 w-full px-3 py-2 text-sm text-muted hover:text-danger hover:bg-danger/5 transition-colors">
