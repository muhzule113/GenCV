...
export default function DocumentCard({ title, type = 'cv', templateName, createdAt, updatedAt, shared, onEdit, onDownload, ...handlers }) {
  ...
  return (
    <div className="card flex hover:border-ink transition-all duration-150">
      {/* Left accent stripe */}
      <div className={`w-1 shrink-0 ${type === 'cv' ? 'bg-clip' : 'bg-ink'}`} />
          ...
          <div className="flex items-center gap-1">
            {onEdit && (
              <button
                ...
                className="p-1.5 text-muted hover:text-clip transition-colors"
                title="Edit"
              >
           ...
           <div className="relative">
              ...
              {menuOpen && (
                <>
                  ...
                  <div role="menu" className="absolute right-0 top-full mt-1 z-20 w-48 bg-surface border border-border py-1">
