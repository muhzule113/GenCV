...
export default function LetterBuilderPage() {
  ...
  if (pageLoading) {
    return (
      <div className="min-h-screen bg-surface-2 dark:bg-surface-dark flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-surface-2 dark:bg-surface-dark">
      ...
      <div className="container-page py-6">
        ...
        <h1 className="text-h2 text-text-primary dark:text-text-primary-dark mb-6">
          ...
          <div className="lg:col-span-3 bg-white dark:bg-slate-800 border border-border dark:border-border-dark rounded-card p-6">
            {existingLetter && !letter ? (
              <div className="space-y-4">
                <div className="bg-warning/5 border border-warning/20 rounded-card p-6 text-center">
                  <svg className="w-12 h-12 text-warning mx-auto mb-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                  </svg>
                  <p className="text-text-primary dark:text-text-primary-dark font-semibold">Surat untuk CV ini sudah ada</p>
                  <p className="text-text-muted dark:text-text-muted-dark text-sm mt-1">Hanya 1 surat per CV diperbolehkan.</p>
